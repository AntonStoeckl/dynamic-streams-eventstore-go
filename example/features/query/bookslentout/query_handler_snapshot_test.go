...
func Test_SnapshotAwareQueryHandler_Handle_SnapshotCreationAndHitWithNoNewEvents(t *testing.T) {
	...
	savedSnapshot, err := wrapper.GetEventStore().LoadSnapshot(ctx, "BooksLentOut", filter)
...
func Test_SnapshotAwareQueryHandler_Handle_SnapshotHitWithNewEvents(t *testing.T) {
	...
	updatedSnapshot, err := wrapper.GetEventStore().LoadSnapshot(ctx, "BooksLentOut", filter)
...
func setupSnapshotTestWithMetrics(t *testing.T) (context.Context, bookslentout.SnapshotAwareQueryHandler, *MetricsCollectorSpy, Wrapper) {
	...
	snapshotHandler, err := bookslentout.NewSnapshotAwareQueryHandler(baseHandler)
